        ...
        <div className='flex flex-1 justify-start flex-col mf:mr-10'>
          ...
          {!currentAccount && (
            <button
              ...
              type='button'
              className='transition-colors  delay-80 flex flex-row justify-center items-center my-5 bg-[#2952e3] p-3 rounded-full cursor-pointer hover:bg-[#2546bd] ease-in-out'
            >
